...
float soundIntensity = 0.3; // for ripple circles
float multiplier2=500;// for box
float intbox= 300;
int multiplier = 1000; // for circle of dots
...
for(int i = 0; i < in.bufferSize() - 1; i++)
{
    box(intbox+multiplier2*in.left.get(i));
